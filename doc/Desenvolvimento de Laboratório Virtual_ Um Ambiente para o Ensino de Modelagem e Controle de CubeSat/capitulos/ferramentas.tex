...
\begin{figure}[htpb]
	\centering
	\includegraphics[scale=0.3]{figs/pina_m.10ad82fe.png}
	\caption{INS para aplicações de espaço}
	{Fonte: https://castroleite.com.br/}}
	\label{fig:6}
\end{figure}
...
O algoritmo TRIAD é uma técnica fundamental na determinação da atitude de uma espaçonave. A atitude de uma espaço-nave é essencialmente a descrição da matriz de rotação que descreve a orientação do referencial fixo à espaçonave, $B$, em relação a um referencial conhecido, como um referencial inercial, $I$.
